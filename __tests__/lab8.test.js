describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    await button.click()
    let button_text = await button.getProperty('innerText');

    if(button_text.jsonValue() != "Remove from Cart") {
      isRemove = false;
    } else {
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    let ccT = await cartCountText.jsonValue();
